...
const Footer = () => {
    const goto1=()=>{
        window.open("https://in.pinterest.com/ojadhav250/", '_blank');
    }
    const goto2=()=>{
        window.open("https://www.instagram.com/omkar_jadhav_ninja/", '_blank');
    }
    const goto3=()=>{
        window.open("https://www.instagram.com/omkar_jadhav_ninja/", '_blank');
    }
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                <div>
                    <h1 className="text-3xl font-extrabold">NINJA</h1>
                </div>
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Models</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">About</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">History</p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Blogs</p>
                </div>
                <div className="flex items-center gap-x-8 mt-6">
                    <div className="cursor-pointer" onClick={goto3}>
                    ...
                    <div className="cursor-pointer" onClick={goto2}>
                    ...
                    <div className="cursor-pointer" onClick={goto1}>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-gray-800">
                        2023 <span className="font-semibold">OmkarJadhav</span>
                    </p>
